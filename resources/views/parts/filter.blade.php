        ...
        <li>
            <form action="{{ route('searchfilter') }}" method="get">
                ...
                <select name="categories"  
                    class="mx-1 w-[188px] text-center my-2 appearance-none  btnmenu h-[43.99px] py-3 text-sm text-white bg-gray-600 border  border-transparent rounded-md focus:border-emerald-500 focus:border-2 hover:border-emerald-500 apple">
