        ...
        <li>
            <form action="{{ route('searchfilter') }}" method="get">
                ...
                <select name="categories"  
                    class="mx-1  w-[188px] text-center my-2 appearance-none btnmenu h-[43.99px] py-3 text-sm text-white bg-gray-600 border  border-transparent rounded-md hover:border-emerald-500 " id="place-holder-center">
                ...
                <select name="note"
                    class="mx-1  w-[188px] my-2 appearance-none btnmenu  h-[43.99px] py-3 text-center text-sm text-white bg-gray-600 border  border-transparent rounded-md hover:border-emerald-500" id="place-holder-center">
                ...
                <select name="prix"
                    class="#place-holder-cente mx-1  w-[188px] my-2 appearance-none btnmenu h-[43.99px] text-center py-3 text-sm text-white bg-gray-600 border  border-transparent rounded-md hover:border-emerald-500 " id="place-holder-center">
              ...
              <a href="/">  <input type="button" 
                    class="mx-1  w-[188px] my-2 h-[43.99px] text-sm text-center  text-gray-100 rounded-md btnmenu bg-violet-500 hover:bg-violet-400 focus:outline-none focus:bg-violet-600" id="place-holder-center" value="Effacer les filtres">
