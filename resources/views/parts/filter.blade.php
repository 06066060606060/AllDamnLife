<div class="w-full    shadow p-5 rounded-lg bg-gray-800">
    <div class="relative">
      ...
      <input type="text" placeholder="Recherche par prix, catégories, type..." class="px-8 py-3 w-full rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0 text-sm">
        </div>
      ...
      <div>
        <div class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 mt-4">
          ...
          <select class="px-4 py-3 w-full rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0 text-sm">
            ...
            <option value="400">Abonnements</option>
