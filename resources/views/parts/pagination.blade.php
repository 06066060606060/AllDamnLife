<div class="flex justify-center space-x-1 dark:text-gray-100 pt-8">
	...
	<button type="button" title="Page 1" class="inline-flex items-center justify-center w-8 h-8 text-sm font-semibold border rounded shadow-md dark:bg-gray-900 dark:text-teal-400 dark:border-teal-400">1</button>
