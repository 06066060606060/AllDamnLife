<section class="max-w-screen-xl pt-4 mx-auto">
    <div class="p-4 mx-4 text-gray-100 ">
        <div class="container flex flex-col  mx-auto lg:flex-row">
            <div class="w-full pl-5 lg:w-1/3"
                style="background-image: url('/img/news.jpg'); background-position: center center; background-size: cover; border-radius: 8px;">
            </div>
            <div class="flex flex-col  object-center w-full p-6 rounded-lg bg-gray-700 lg:w-2/3 md:p-8 lg:p-12">
