<div class="">
	...
	<div class="container flex items-center justify-center  space-y-4 sm:justify-between max-w-screen-xl mx-auto " style="background-image: url('https://source.unsplash.com/random/640x480'); background-position: center center; background-blend-mode: multiply; background-size: cover;">
