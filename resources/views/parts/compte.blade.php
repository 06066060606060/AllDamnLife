<div class="max-w-screen-xl mx-auto">
    ...
    <section class="p-6 text-gray-50">
        <form action="{{ Route('updateprofil', Auth::user()->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <fieldset class="grid grid-cols-4 gap-6 p-6 bg-gray-600 rounded-md shadow-sm btnmenu">
                <div class="flex flex-row mx-auto space-x-2 sm:items-center justify-items-center md:justify-evenly">
                    <img src="{{ asset(Auth::user()->photo) }}" id="imgbfr" alt=""
                        class="block w-16 h-16 mr-4 rounded-full cover ">
                    ...
                    <label for="files"
                        ...
                        avatar</label>
                    <input type="file" style="display:none" id="files"  name="photo"
                        value="">
                ...
                <div class="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                    <div class="col-span-full sm:col-span-3">
                        ...
                        <input id="firstname" type="text" placeholder="Nom" name="nom"
                            class="w-full pl-2 text-gray-900 border-gray-700 rounded-md focus:ring focus:ring-opacity-60 "
                            value="{{ Auth::user()->nom }}">
                    </div>
                    <div class="col-span-full sm:col-span-3">
                    ...
                    <div class="col-span-full">
                        ...
                        <input required id="address" name="address" type="text" placeholder=""
                            class="w-full pl-2 text-gray-900 border-gray-700 rounded-md focus:ring focus:ring-opacity-60 "value="{{ Auth::user()->address }}">
                    </div>
                    <div class="col-span-full sm:col-span-2">
                        <label for="phone" class="text-sm">Numéro de téléphone</label>
                        <input required id="phone" name="phone" type="text" placeholder=""
                            class="w-full pl-2 text-gray-900 border-gray-700 rounded-md focus:ring focus:ring-opacity-60 "
                            value="{{ Auth::user()->numero_telephone }}">
                    </div>
                    <div class="col-span-full sm:col-span-2">
                        <label for="ville" class="text-sm">Ville</label>
                        <input id="ville" type="text" placeholder="" name="city"
                            class="w-full pl-2 text-gray-900 border-gray-700 rounded-md focus:ring focus:ring-opacity-60 "
                            value="{{ Auth::user()->city }}">
                    </div>
                    <div class="col-span-full sm:col-span-2">
                        <label for="pays" class="text-sm">Pays</label>
                        <input id="pays" type="text" placeholder="" name="country"
                            class="w-full pl-2 text-gray-900 border-gray-700 rounded-md focus:ring focus:ring-opacity-60 "
                            value="{{ Auth::user()->country }}">
                    </div>
                    <div class="col-span-full sm:col-span-2">
                        <label for="zip" class="text-sm">Code postale</label>
                        <input id="zip" type="text" placeholder="" name="zip"
                            class="w-full pl-2 text-gray-900 border-gray-700 rounded-md focus:ring focus:ring-opacity-60 "
                    ...
                    <div class="col-span-full sm:col-span-2">
                        ...
                        <button type="submit"
                            class="px-4 py-2 mt-4 bg-indigo-900 border border-gray-100 rounded-md">Valider</button>
                    </div>
                </div>
