            ...
            <div x-cloak x-show="modelOpen" x-transition:enter="transition ease-out duration-300 transform"
                ...
                <section class="">
                    ...
                    <div class="w-full max-w-md p-8 space-y-3 text-gray-100 bg-gray-600 rounded-xl">
                        ...
                        <form action="/giveCards" class="space-y-6 ng-untouched ng-pristine ng-valid" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="space-y-1 text-sm">
                                ...
                                <textarea name="description" class="block w-full mt-1 shadow-sm  placeholder:text-right px-4 py-3 text-gray-100 bg-gray-900 border-gray-700 rounded-md focus:border-teal-400"
                                    rows="4" ></textarea>
                            </div>
                            <div class="space-y-1 text-sm">
