...
class ProduitsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Produits::create(['titre'=> 'Carte Cadeau Netflix', 'description'=> 'Films, programmes TV et contenu original, il y en a pour tous les goûts. Les membres de Netflix peuvent regarder leurs programmes de divertissement favoris chez eux et sur tous leurs écrans. Sans aucune publicité. Les membres peuvent utiliser les cartes Netflix pour payer leur abonnement. Les personnes non abonnées peuvent les utiliser pour regarder Netflix immédiatement, sur n’importe quel appareil.', 'prix'=>'25',  'image'=> '/img/netflix.png', 'note'=>'3']);
        Produits::create(['titre'=> 'Carte Cadeau Disney+', 'description'=> 'Disney+, c est le cadeau idéal pour tous. Avec un divertissement en continu signé Disney, Pixar, Marvel, Star Wars, National Geographic et Star, on ne peut pas s ennuyer avec un abonnement Disney+. Des productions originales en passant par les grands classiques ou les monuments du petit écran, chacun trouvera son bonheur et aura toujours quelque chose de nouveau à découvrir !', 'prix'=>'10',  'image'=> '/img/disney.png', 'note'=>'4']);
